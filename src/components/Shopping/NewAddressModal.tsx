...
function NewAddressModal({ isOpen, setIsOpen }: NewAddressModalProps) {
  ...
  return isOpen ? (
    <>
      ...
      <section className="lg:w-[50rem] w-[32rem] max-md:w-full my-10 z-10 absolute justify-self-center bg-white rounded-xl grid grid-cols-1 grid-rows-[1fr-2fr] gap-y-6 ">
                ...
                <section className="grid grid-cols-2 grid-rows-2 max-md:grid-cols-1 max-md:grid-rows-4 gap-x-2">
                  <div className="mr-6">
                    ...
                    <input
                      ...
                      className="w-56 lg:w-40 max-md:w-[96%] placeholder:text-xs placeholder:font-medium border rounded-lg border-gray-300 h-10 py-1 px-2"
                      {...register("fullName", {
                  ...
                  <div className="mr-2 max-md:mr-6">
                    ...
                    <input
                      ...
                      dir="ltr"
                      className="w-56 lg:w-40 max-md:w-[96%] placeholder:text-xs placeholder:font-medium placeholder:pr-12 border border-gray-300 rounded-lg h-10 py-1 px-2 "
