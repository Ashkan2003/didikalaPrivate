...
const EmptyShoppingCart = () => {
    return(
        <>
            <div className="flex flex-col space-y-96 h-screen">
                ...
                <div className="flex items-center mr-20 ">
                    <Image width={310} height={250} className="mx-4 rounded-xl  mt-11 " src={'/imgs/small-banner-1.jpg'} alt="banner1"/>
                    <Image width={310} height={250} className="mx-4 rounded-xl mt-11 " src={'/imgs/small-banner-2.jpg'} alt="banner2"/>
                    <Image width={310} height={250} className="mx-4 rounded-xl mt-11 " src={'/imgs/small-banner-3.jpg'} alt="banner3"/>
                    <Image width={310} height={250} className="mx-4 rounded-xl mt-11 " src={'/imgs/small-banner-4.jpg'} alt="banner4"/>
                </div>
            </div>
